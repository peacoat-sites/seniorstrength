...
You might be wondering whether sitting down can actually raise your heart rate enough to matter. It can. The real question is understanding what "enough" actually means for your body right now.
...
A resistance band (a light one, like a Theraband Yellow or Red, which typically runs $6 to $10) opens up a huge range of upper body and pulling movements. A light pair of dumbbells, somewhere between 1 and 5 pounds depending on where you're starting, lets you add load to arm movements in a way that bumps your heart rate noticeably. A small inflatable seat cushion disc (the OPTP Pro-Roller Soft Density or similar, around $20 to $30) can introduce a mild stability challenge once you've been training for a while and want to progress.

Skip the seated pedal machines marketed heavily toward seniors, the kind you see advertised on late-night TV for $40 to $60. Most don't provide enough resistance to be cardiovascularly useful, and the ones that do aren't built to last. If you want a pedal option, a mid-range under-desk bike like the DeskCycle 2 (around $170) is legitimate equipment. But it's absolutely not a prerequisite.

---

## A Real Seated Cardio Workout, From Start to Finish

Here's what a solid 25-minute session actually looks like. This is a template I've used with clients ranging from their late 60s to their early 90s. The goal is to get your heart rate into a moderate effort zone, for most people over 65 that means something around 50-70% of your estimated max heart rate, but more practically, it means you can speak in short sentences but not hold a comfortable conversation.
...
What I've seen go wrong is people add intensity too fast because they feel good and want to push. Then something gets strained, they take two weeks off, and they're back to square one. Patience here isn't timidity. It's how you actually make consistent gains over months and years rather than sprinting into an injury.

A heart rate monitor helps enormously with this. Even a basic one. The Apple Watch Series 3, which you can find refurbished for around $80 to $100, has good enough heart rate tracking for this purpose. A Fitbit Inspire 3 runs about $100 new and is simpler to use. You're not looking for precision. You're looking for an honest external signal about whether you're working hard enough, and whether your recovery is trending in the right direction over time.
...
If you have a pacemaker, uncontrolled hypertension, recent cardiac events, or any condition where exercise clearance is required, talk to your doctor before starting. I know that sounds like boilerplate. It isn't. Seated cardio is low-risk but not no-risk, and your doctor knowing what you're doing matters.
