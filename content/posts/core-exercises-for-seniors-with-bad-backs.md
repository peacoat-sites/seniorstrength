...
slug: "core-exercises-for-seniors-with-bad-backs"
affiliate_disclosure: true
faqs:
  - q: "How often should seniors do core exercises?"
    a: "Three to four sessions per week is a reasonable target for most older adults. Unlike large muscle group training, core stabilization work doesn't need long recovery windows, but you shouldn't be doing it when your muscles are already fatigued from another workout, because form breaks down and that's when people get hurt."
  - q: "Can I do these exercises if I have a herniated disc?"
    a: "Many people with herniated discs do very well with the exercises described here, because they avoid spinal flexion under load, which is the main aggravating movement for most disc injuries. That said, herniation severity varies widely, and what works for a small L5-S1 protrusion may not work for a larger extrusion with nerve compression. Get a physical therapist's input if you're in an active pain episode."
  - q: "Is walking enough to strengthen the core for seniors?"
    a: "Walking is genuinely good for you in many ways, and it does require core stabilization. But it's not a substitute for targeted core training. The loading demand on the core during walking is relatively low, and it doesn't specifically train the deep stabilizers in the way that something like a bird dog or dead bug does."
  - q: "My doctor told me to do crunches. Should I?"
