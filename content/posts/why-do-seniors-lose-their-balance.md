...
faqs:
  - q: "At what age do people typically start losing balance?"
    a: "Measurable changes in vestibular function and proprioception can begin as early as the mid-50s, though many people don't notice functional balance decline until their late 60s or 70s. The speed of decline is heavily influenced by activity levels, medication use, and underlying health conditions, so it varies significantly from person to person."
  - q: "Can balance actually be improved after age 70?"
    a: "Yes, and often significantly. The research on this is encouraging: balance training, particularly tai chi and single-leg stability work, has been shown to produce meaningful improvements in adults in their 70s and 80s. The nervous system retains the capacity to adapt and improve proprioceptive sensitivity even in later life, though progress is usually slower than it would be at younger ages."
  - q: "Is dizziness the same as balance problems?"
    a: "Not exactly. Dizziness can contribute to balance problems, and they often co-occur, but they have different causes. True balance impairment often happens without any sensation of dizziness. Dizziness specifically (especially a spinning sensation called vertigo) often points to vestibular issues, while balance problems without dizziness more commonly involve proprioception, leg weakness, or reaction time. Both deserve evaluation."
  - q: "Should seniors avoid exercise after a fall?"
